# Genetics Bridge & Trait Inheritance (MC 26.2)
...
| **Target Platform** | Minecraft 26.2 / MCA Reborn 8.0.0+ |
...
- [[Spring-Damper Physics Engine|zh_tw-26.2-Spring-Damper-Physics-Engine]]
- [[Model Geometry & Render Layers|zh_tw-26.2-Model-Geometry-and-Render-Layers]]
- [[Architecture & Mixins|zh_tw-26.2-Architecture-and-Mixins]]
- Return to [[26.2 Portal Home|zh_tw-26.2-Home]]
